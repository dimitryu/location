...
אפליקציית PWA למעקב מיקום משפחתי בזמן אמת, מבוססת Firebase Firestore ו-Leaflet.js. מותקנת ישירות מהדפדפן — ללא חנות אפליקציות.

**קישור לאפליקציה:** [dimitryu.github.io/location](https://dimitryu.github.io/location/)
